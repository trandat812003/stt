...
PARQUET_DIR = Path("/media/trandat/DataVoice/Vietnamese_ASR_TestingData/data")
OUT_DIR = Path("/media/trandat/Data/Vietnamese_ASR_TestingData/output")
...
save_file(OUT_DIR, manifests, "Vietnamese_ASR_TestingData_{}.jsonl")
