...
# Thư mục chứa audio
audio_root = "/media/trandat/DataVoice/spgispeech/data/audio/"
...
for split in ["test", "dev"]:
    ...
    with open(os.path.join(csv_dir, csv_file), newline='', encoding='utf-8') as f_in, \
        ...
        for row in reader:
            wav_path = os.path.join(audio_root, split, row['wav_filename'])
            ...
            entry = {
                ...
                "file_path": os.path.join(split, row['wav_filename']), 
                "duration": duration, 
